 ...
 */
export class PieceWithHistoriqueSearchQuery extends SearchQuery {
  ...
  public dateDebut: SearchField<Date>;
  public dateFin: SearchField<Date>;
  public quantiteEntree: SearchField<number>;
  public quantiteSortie: SearchField<number>;
  ...
  constructor() {
    ...
    this.dateDebut = CustomSearchField.of();
    this.dateFin = CustomSearchField.of();
    this.quantiteEntree = CustomSearchField.of();
    this.quantiteSortie = CustomSearchField.of();
  }
}
